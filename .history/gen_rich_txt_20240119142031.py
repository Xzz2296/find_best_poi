...
# 读取Excel文件
excel_file = r'E:\xpj\research\POI\summary_result\daressalaam_summary_output.csv'  # 替换成你的Excel文件路径
...
# 指定保存文件的目录
output_directory = '/workspace/DATA/xpj/dataset/prompt_text/bangkok/'  # 替换成你想要保存文件的目录路径
...
for index, row in tqdm(df.iterrows(), total=total_rows, desc="生成.txt文件进度"):
    ...
    # rich_info ="This is a high-income area."
    rich_info ="This is an upper-middle-income area."
    # rich_info ="This is a low-income area."
