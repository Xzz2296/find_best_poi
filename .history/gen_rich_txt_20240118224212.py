...
# 读取Excel文件
excel_file = r'E:\xpj\research\POI\summary_result\bangkok_summary_output.csv'  # 替换成你的Excel文件路径
...
# 指定保存文件的目录
output_directory = r'E:\xpj\research\POI\prompt_text\bangkok'  # 替换成你想要保存文件的目录路径
